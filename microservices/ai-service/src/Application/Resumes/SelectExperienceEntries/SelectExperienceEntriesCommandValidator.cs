...
internal sealed class SelectExperienceEntriesCommandValidator : AbstractValidator<SelectExperienceEntriesCommand>
{
    public SelectExperienceEntriesCommandValidator()
    {
        //RuleFor(x => x.Name)
        //    .NotEmpty()
